-- NeuroSys MySQL Schema & Database Initialization Script
-- Database Name: real_time_system_monitoring

CREATE DATABASE IF NOT EXISTS real_time_system_monitoring CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE real_time_system_monitoring;
